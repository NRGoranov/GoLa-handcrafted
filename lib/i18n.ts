...
const dictionary: Record<Locale, SiteCopy> = {
  ...
  bg: {
    ...
    inquiry: {
      ...
      success: "Благодарим — получихме запитването Ви.",
      successPopup: {
        title: "Запитването е изпратено",
        message:
          "Благодарим — получихме запитването Ви. Изпратихме копие на посочения от вас имейл с подробностите, които изпратихте.",
        messageNoEmail: "Благодарим — получихме запитването Ви. Ще се свържем с вас скоро.",
        close: "Затвори"
      }
    },
    footer: {
